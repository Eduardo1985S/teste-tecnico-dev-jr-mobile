...
## Descrição
Aplicativo criado em React Native com Expo para apresentar um perfil profissional de um candidato a Desenvolvedor Mobile Júnior. O app demonstra navegação por abas inferiores, telas separadas e uso dos componentes básicos do React Native.
...
- Lista de habilidades com pelo menos 5 itens
- Tela de projetos com duas descrições de projetos
...
## Telas
- **Perfil:** mostra nome, imagem, cargo e um texto de apresentação pessoal na seção "Sobre mim".
- **Habilidades:** lista de habilidades exibida com `FlatList`, cada habilidade em um cartão separado.
- **Projetos/Contato:** apresenta dois projetos e uma área de contato com e-mail, links e um formulário simples para envio de mensagem.

## Organização do código
- `App.js` contém a configuração da navegação por abas usando React Navigation.
...
- A estilização é feita com `StyleSheet` em cada componente de tela.

## Diferenciais
- Layout organizado e limpo com boa separação de conteúdo.
- Uso correto de componentes básicos do React Native e navegação por abas.
- Formulário de contato funcional com validação básica.
- Estrutura de projeto clara e fácil de entender.
